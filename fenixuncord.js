...
/* shadows */
--shadow-border: 0 0 0 1px rgba(0,0,0,.2);
--shadow-high: 0 10px 20px rgba(0,0,0,.4);
...
--background-tertiary: #232428;
--background-floating: #1e1f22;

/* modifiers */
--background-modifier-accent: #3f4147;
--background-mentioned: #2f3136;
...
/* elevation */
--elevation-high:0 8px 16px rgba(0,0,0,.4);
...
#undiscord .log-info { color: #00bfff; }
#undiscord .log-verb { color: #848484; }
#undiscord .log-warn { color: #ffff00; }
#undiscord .log-error { color: #ff0000; }
#undiscord .log-success { color: #00ff00; }
...
#undiscord .main { display: flex; max-width: calc(100% - 270px); background-color: var(--bg-overlay-chat, var(--background-base-lower)); flex-grow: 1; }
...
<div id="undiscord" class="browser container redect" style="display:none;">
<div class="header">
...
<div id="hide" class="icon" aria-label="Close" role="button" tabindex="0" style="display:none;">
<svg aria-hidden="false" width="24" height="24" viewBox="0 0 24 24">
<path fill="currentColor"
...
<div class="sectionDescription2">
<label><input id="includeNsfw" type="checkbox">This is a NSFW channel</label>
</div>
</fieldset>
...
<div class="tbar col">
<div class="row">
<button id="toggleSidebar" class="sizeMedium icon" style="display:none;">☰</button>
<button id="start" class="sizeMedium" style="width: 150px;" title="Start the deletion process">Start</button>
<button id="stop" class="sizeMedium" style="width: 150px;" title="Stop the deletion process" disabled>Stop</button>
<button id="clear" class="sizeMedium" style="width: 150px;">Clear</button>
<label class="row" style="display:none;" title="Hide sensitive information on your screen for taking screenshots">
<input id="redact" type="checkbox" checked> Hide Content
</label>
</div>
<div class="row">
